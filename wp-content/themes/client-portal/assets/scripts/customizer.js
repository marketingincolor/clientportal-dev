...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-client_portal_header_button select' ),
			headerLinkButton: $( '#customize-control-client_portal_header_button_url' ),
			headerLinkText: $( '#customize-control-client_portal_header_button_text' )
		};
	};
