...
if ( $categories || $tags ) {
	$args = client_portal_get_recent_posts_query_arguments( $categories, $tags );
}
...
$recent_posts = client_portal_get_recent_posts( $args );
