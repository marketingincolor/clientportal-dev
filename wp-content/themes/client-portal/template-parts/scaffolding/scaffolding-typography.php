...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'client-portal' ); ?></h2>
	...
	client_portal_display_scaffolding_section(
		array(
			...
			'usage'       => '<del>Client Portal</del>',
			'output'      => '<p>We use <del>Client Portal</del> wd_s to build themes.</p>',
		)
	);
