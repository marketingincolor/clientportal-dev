 ...
 */
function client_portal_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = client_portal_scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header display-flex flex-start space-between">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'client-portal' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'client-portal' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'client-portal' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'client-portal' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'client-portal' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'client-portal' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function client_portal_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function client_portal_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function client_portal_hook_theme_scaffolding() {
...
add_action( 'client_portal_scaffolding_content', 'client_portal_hook_theme_scaffolding' );
